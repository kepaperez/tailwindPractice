...
export default function Nav2() {
  ...
  return (
    <>
      <nav className="  bg-white py-4 sticky top-0 z-10 mx-4 sm:mx-10">
          ...
          <div className='flex w-full sm:justify-end '>
            ...
            >
              <li className='p-5 sm:p-0 '>
                ...
                <Link to={"/"} className="text-black text-md hover:underline underline-offset-8">
                  Home
                </Link>

              </li>
              <li className='p-5 sm:p-0'>
                <a href="#products" className="text-black text-md hover:underline underline-offset-8">
                  Products
                </a>
              </li>
